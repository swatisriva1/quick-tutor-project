# Generated by Django 3.0.2 on 2020-03-21 06:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.CASCADE, to='tutor.Profile')),
            ],
        ),
    ]
